    ...
    >
      ...
      > 
        ...
        <Box
          ...
          onClick={() => window.open("https://carbonlensai-personal2.onrender.com/", "_blank")} // akhne change korbi ("_self" dile oi tab ei open hbe r "_blank" dile onno tab e open hbe)
        >
          <Box sx={glowBorder} />
